...
function PostThumbnail({ post, index }: { post: PostView; index: number }) {
  return (
    <div
      ...
      <div className="px-5 -mt-10 relative">
        <div className="flex items-end justify-between">
          ...
          <button
            ...
            className={`mb-1 flex items-center gap-1.5 px-5 py-2 rounded-xl text-xs font-semibold transition-smooth active:scale-95 disabled:opacity-50 ${
              isFollowing
